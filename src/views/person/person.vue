<template>
    <div>
          ...
          <!--<i class="el-icon-warning" style="color:#F56C6C;"></i>-->
            ...
            <el-tab-pane label="辅导员信息" name="2">
                <el-form ref="form" :model="Info" size="mini">
                    <el-form-item label="辅导员:" v-for="(item,index) in Info.headmaster" v-if="Info.headmaster.length > 0"
                                  :key="index">
                    ...
                    <el-form-item label="志愿者:" v-for="(item,index) in Info.volunteer" v-if="Info.volunteer.length > 0"
                                  :key="index">
            ...
            <el-tab-pane label="学生信息" name="3">
                <el-form ref="form" :model="Info" :rules="rule_std" size="mini">
                    <el-form-item label="曾用名">
                        <el-input v-model="Info.cym"></el-input>
                    </el-form-item>
                    <el-form-item label="联系电话" required prop="lxdh">
                    ...
                    <el-form-item label="全年总收入（万元）" required>
            ...
            <el-tab-pane label="困难认定信息" name="4">
                <el-form ref="form" :model="Info" size="mini">
                    ...
                    <div v-if="Info.sfpkjt == '是'">
                        <el-form-item label="家庭主要收入来源情况" required>
                            <el-input type="textarea" v-model="Info.identification.ztzysrlyqk"></el-input>
                        </el-form-item>
                        <el-form-item label="家庭是否遭受自然灾害" required>
                            <el-radio-group v-model="Info.identification.sfsz">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="家庭遭受自然灾害情况" required>
                            <el-input type="textarea" v-model="Info.identification.szqk"></el-input>
                        </el-form-item>
                        <el-form-item label="家庭成员因残疾、年迈而劳动能力弱情况" required>
                            <el-input type="textarea" v-model="Info.identification.cjnmldlrqk"></el-input>
                        </el-form-item>
                        <el-form-item label="家庭欠债情况" required>
                            <el-input type="textarea" v-model="Info.identification.qzqk"></el-input>
                        </el-form-item>


                        <el-form-item label="学生已获社会资助情况" required>
                            <el-input type="textarea" v-model="Info.identification.shzzqk"></el-input>
                        </el-form-item>
                        <el-form-item label="家庭遭受突发意外情况" required>
                            <el-input type="textarea" v-model="Info.identification.tfywqk"></el-input>
                        </el-form-item>
                        <el-form-item label="是否孤儿" required>
                            <el-radio-group v-model="Info.identification.jtlxsfge">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="是否单亲" required>
                            <el-radio-group v-model="Info.identification.jtlxsfdq">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="是否家庭经济困难残疾学生及残疾人子女" required>
                            <el-radio-group v-model="Info.identification.jtlxsfcjxsjcjzn">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="是否烈士或优抚对象子女" required>
                            <el-radio-group v-model="Info.identification.jtlxsflshyfdxzn">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="是否低保家庭" required>
                            <el-radio-group v-model="Info.identification.jtlxsfdbjt">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="是否建档立卡贫困户" required>
                            <el-radio-group v-model="Info.identification.jtlxsfjdlkpkh">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="是否特困供养学生" required>
                            <el-radio-group v-model="Info.identification.jtlxsftkgyxs">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="是否其他家庭类型" required>
                            <el-radio-group v-model="Info.identification.jtlxqt">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="入学报到是否存在困难" required>
                            <el-radio-group v-model="Info.identification.sfrxbdczkn">
                                <el-radio label="是"></el-radio>
                                <el-radio label="否"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="入学报到困难情况" required>
                            <el-input type="textarea" v-model="Info.identification.rxbdczknqk"></el-input>
                        </el-form-item>
                    </div>
                </el-form>
            </el-tab-pane>
            ...
            <el-tab-pane label="团员信息" name="6">
                <el-form size="mini">
                    ...
                    <div v-if="Info.league.sfrd == '是'">
                        ...
                        <el-form-item label="入团地点" required>
            ...
            <el-tab-pane label="党员信息" name="7">
                <el-form size="mini">
                    ...
                    <div v-if="Info.party.sfrd == '是'">
                        ...
                        <el-form-item label="入党地点" required>
                            <el-input v-model="Info.party.rddd"></el-input>
                        </el-form-item>
                        <el-form-item label="介绍人姓名" required>
                            <el-input v-model="Info.party.jsrxm"></el-input>
                        </el-form-item>
                        <el-form-item label="介绍人单位" required>
            ...
            <el-tab-pane label="学习工作经历" name="10">
                <div>
                    学习工作经历
                    <i class="el-icon-circle-plus" type="primary" @click="addgzjy"></i>
                </div>
                <el-carousel
                        :interval="5000"
                        arrow="always"
            ...
            <el-tab-pane label="受奖励信息" name="11">
                <div>
                    奖励
                    <i class="el-icon-circle-plus" type="primary" @click="addjy"></i>
                </div>
                <el-carousel
                        :interval="5000"
                        arrow="always"
            ...
            <el-tab-pane label="受处分信息" name="12">
                <div>
                    惩罚
                    <i class="el-icon-circle-plus" type="primary" @click="addcf"></i>
                </div>
                <el-carousel
                        :interval="5000"
                        arrow="always"
                        ...
                        height="550px"
                >
                    <el-carousel-item v-for="(item,index) in Info.punishment" :key="index">
                        <div class="chengyuan">
                            <span></span>
                            受处罚经历{{index + 1}}
        ...
        <div class="btn-area">
            ...
            <el-button v-if="activeName != '12'" type="primary" @click="nextStep">下一步</el-button>
            <el-button v-if="activeName == '12'" type="primary" @click="submit">提交</el-button>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            save(flag) {
                ...
                this.$ajax
                    .post("/student_api/save", {jsonObjectStr: data, finishTag: m})
                    .then(res => {
                        console.log(res);
                    });
            },
